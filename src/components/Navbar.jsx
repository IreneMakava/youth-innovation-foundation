  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white shadow-sm">
      ...
      <div className="border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-2 sm:px-4 py-0 flex items-center gap-3 sm:gap-4">
          ...
          <div className="flex-1 min-w-0 flex flex-col items-end sm:items-center justify-center text-right sm:text-center flex py-1 pl-0">
