const stats = [
  {
    value: "500+",
    label: "Youth Innovators Supported",
    icon: (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((stat) => (
            ...
            >
              <div className="inline-flex items-center justify-center w-14 h-14 rounded-xl bg-white/10 text-primary mb-4 group-hover:bg-primary group-hover:text-white transition">
                {stat.icon}
              </div>
