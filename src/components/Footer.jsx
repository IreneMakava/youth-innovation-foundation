      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="text-sm space-y-2 text-gray-400">
              <li>
                <a href="https://youthinnovationfoundation.or.tz" className="hover:text-white transition" target="_blank" rel="noopener noreferrer">
                  youthinnovationfoundation.or.tz
                </a>
              </li>
              <li>
                <a href="mailto:info@youthinnovationfoundation.or.tz" className="hover:text-white transition">
                  info@youthinnovationfoundation.or.tz
                </a>
              </li>
              <li>Phone: +255 775 878 751</li>
              <li>
                P.O. Box 90258, Samora Avenue,<br />
                Holland House 4th Floor, DSM, Tanzania
              </li>
            </ul>
          </div>
          <div>
            ...
            <p className="text-sm text-gray-400 mb-3">
              Stay updated on programs and opportunities.
            </p>
            <form className="flex gap-2" onSubmit={(e) => e.preventDefault()}>
              <input
                type="email"
                placeholder="Your email"
                className="flex-1 px-3 py-2 rounded-lg bg-white/10 border border-white/20 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary text-sm"
                aria-label="Email for newsletter"
              />
              <button
                type="submit"
                className="px-4 py-2 bg-primary text-white text-sm font-medium rounded-lg hover:bg-blue-600 transition"
              >
                Sign up
              </button>
            </form>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-10 mt-10 border-t border-white/10">
          ...
          <p className="text-sm text-gray-500">
            © {new Date().getFullYear()} Youth Innovation Foundation. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
